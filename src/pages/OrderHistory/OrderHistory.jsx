...
const OrderHistory = () => {
  ...
  return (
    <div className="container py-4">
      <h3 className="mb-4 fw-bold">Lịch sử đơn hàng</h3>
              ...
              >
                <Card.Body>
                  <div className="d-flex justify-content-between align-items-center">
                    <h5 className="fw-semibold">Đơn hàng #{order.id}</h5>
                    <span
                      className={`badge rounded-pill px-3 py-2 ${order.status === "Đã duyệt"
